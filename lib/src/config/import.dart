...
export 'package:aplicacion_basica_curso/src/ui/views/pagina1.dart';
export 'package:aplicacion_basica_curso/src/ui/views/pagina2.dart';
export 'package:aplicacion_basica_curso/src/ui/views/pagina3.dart';
export 'package:aplicacion_basica_curso/src/ui/views/screen404error.dart';
